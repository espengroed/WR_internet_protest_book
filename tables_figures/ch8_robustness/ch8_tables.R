...
print(xtable(results, digits=4, caption="The effect of sending Internet penetration on anti-regime protest diffusion, controlling for reporting  (city-week resolution, logistic regression).", label="ch8:logitbare_rob"), 
      hline.after = c(-1,0,nrow(results)-3,nrow(results)),
      file="ch8_robustness/diffusion_cityweek_bayes_ml_bare_robustness.tex")
...
print(xtable(results, digits=4, caption="The effect of sending Internet penetration on anti-regime protest diffusion, interaction with logged weeks since protest in sending city, controlling for reporting  (city-week resolution, logistic regression).", label="ch8:logitthreeway_rob"), 
      hline.after = c(-1,0,nrow(results)-3,nrow(results)),
      file="ch8_robustness/diffusion_cityweek_bayes_ml_threeway_robustness.tex")
...
print(xtable(results, digits=4, caption="The effect of sending Internet penetration on anti-regime protest diffusion, interaction with logged weeks since protest and repression in sending city, controlling for reporting  (city-week resolution, logistic regression).", label="ch8:logitthreeway_repr_rob"), 
      hline.after = c(-1,0,nrow(results)-3,nrow(results)),
      file="ch8_robustness/diffusion_cityweek_bayes_ml_threeway_repr_robustness.tex")
...
print(xtable(results, digits=4, caption="The effect of sending Internet penetration on anti-regime protest diffusion, interaction with logged distance between sending and receiving cities, controlling for reporting  (city-week resolution, logistic regression).", label="ch8:logitdistance_rob"), 
      hline.after = c(-1,0,nrow(results)-3,nrow(results)),
      file="ch8_robustness/diffusion_cityweek_bayes_ml_distance_robustness.tex")
