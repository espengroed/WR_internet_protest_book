print("##################")
print("Chapter 8 models - ROBUSTNESS")
print("##################")

summary(cityweek.data.diffusion$report_ratio_ag_l_centered)
...
save.image(file = "chapter8_results_robustness.RData")
